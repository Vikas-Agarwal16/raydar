...
export const SITES = [
  ...
  { slug: 'cbse', name: 'CBSE', url: 'https://www.cbse.gov.in/cbsenew/cbse.html', category: 'exams' },
...
{ slug: 'amazon-sde-intern', name: 'Amazon — SDE Intern (India)', url: 'https://www.amazon.jobs/en/search?base_query=software+development+engineer+intern&country=IND', category: 'internships' },
  ...
  { slug: 'amazon-ml-intern', name: 'Amazon — ML Intern (India)', url: 'https://www.amazon.jobs/en/search?base_query=machine+learning+intern&country=IND', category: 'internships' },  
...
// HACKATHONS — :06 cron
 ...
 { slug: 'ipu', name: 'IPU CET Counselling', url: 'https://ipu.admissions.nic.in/', category: 'counselling' },
];
