...
export const SITES = [
  ...
  { slug: 'gate', name: 'GATE', url: 'https://gate.iitr.ac.in', category: 'exams' },
  ...
  // HACKATHONS — :06 cron
  { slug: 'devfolio', name: 'Devfolio', url: 'https://devfolio.co', category: 'hackathons' },
  ...
  { slug: 'uptac', name: 'UPTAC', url: 'https://uptac.admissions.nic.in', category: 'counselling' },
];
